...
var MAC={
    ...
    'Qrcode':{
        'Init':function(){
            $('.mac_qrcode').attr('src','//api.lvdoui.cn/qrcode/?w=150&h=150&url=' + MAC.Url);
        }
    },
    'Shorten': {
        'Init':function(){
        ...
        'Get':function(url,call){
            ...
            MAC.Ajax('//api.lvdoui.cn/shorten/?callback=callback&url='+ encodeURIComponent(url),'get','jsonp','',function(r){
                if (r.code == 1) {
                    if($('.mac_shorten').length>0) {
