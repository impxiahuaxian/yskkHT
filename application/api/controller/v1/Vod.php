        ...
        $data = (object)[
            ...
            'list'=>[
                [
                    ...
                    'vod_list'=>model('Vod')->listData(['vod_play_from'=>qq,'vod_year'=> 2022],'vod_time desc',1,12)['list'],
                ],
                [
                    'vod_type_id'=>2,
                    ...
                    'vod_list'=>model('Vod')->listData(['vod_play_from'=>qiyi,'vod_year'=>2022,'type_id'=>array('neq', 4)],'vod_time desc',1,12)['list'],
                ],listData
                [
                    'vod_type_id'=>3,
                    ...
                    'vod_list'=>model('Vod')->listData(['vod_play_from'=>youku,'vod_year'=>2022],'vod_time desc',1,12)['list'],
                ...
                [
                    ...
                    'vod_list'=>model('Vod')->listData(['vod_play_from'=>mgtv,'vod_year'=>2022],'vod_time desc',1,12)['list'],
